                    ...
                    <>
                        <div className='flex items-center space-x-6'> 
                            <div className='text-primary hover:text-brand-teal-600 transition-colors'> 
                                ...
                                > 
                                    ...
                                    <span className="ml-1">Back to payroll</span>
                                </Link> 
                            </div> 
                        </div>
                        ...
                        <Card className='border-0 bg-card/50 backdrop-blur-sm'>
                            <CardContent className='flex flex-col items-center justify-center py-12'>
                                ...
                                <CardTitle className='text-xl mb-2'>No Employee Found</CardTitle>
                                <CardDescription className='text-center'>
                                    The employee with ID {id} could not be found in the system.
                                </CardDescription>
                                <Button className='mt-4' asChild>
                                    <Link href="/auth/login/dashboard/payroll/">
                                        Return to Payroll
                                    </Link>
                                </Button>
                            </CardContent>
